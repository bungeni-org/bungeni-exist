...
if [ -z "$1" ]; then
  ...
  echo "Syntax : ./build_exist_rev.sh <rev no> <folder with exist source> scriba" 
  echo "Third parameter is optional ; <rev no> can be a number or HEAD "
  exit 91
fi

EXIST_REPO="svn://svn.code.sf.net/p/exist/code/stable/eXist-2.0.x"
# Exist Revision
EXIST_REV=$1
