                    ...
                    <tbody id="r-transattrs" xf:repeat-nodeset="transition">
                        <tr>
                            ...
                            <td style="color:steelblue;font-weight:bold;">
                                <xf:input ref="@condition" incremental="true">
                                    <xf:label/>
                                    <xf:hint>Condition to be met for this transition to be valid</xf:hint>
                                    <xf:help>Enter a valid condition</xf:help>
                                    <xf:alert>invalid condition</xf:alert>
                                </xf:input>
                            </td>                                
                            <td>
                            ...
                            <td style="color:blue;">
                                <xf:trigger>
                                    <xf:label>insert</xf:label>
                                    <xf:action>
                                        <xf:insert nodeset="." at="index('r-transattrs')" position="before"></xf:insert>
                                    </xf:action>
                                </xf:trigger> 
                            </td>                                            
                            <td style="color:red;">                                           
