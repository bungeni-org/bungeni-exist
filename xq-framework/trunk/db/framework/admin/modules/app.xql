...
declare function app:get-legislature($node as node(), $model as map(*)) {
    <ul>
    {
        ...
        return
            <li><a href="chamber.html?type={$chamber/type}" title="{$chamber/identifier}">{data($chamber/type/@displayAs)}</a></li>                
    }
    </ul>
};
...
function app:menu-groups($node as node(), $model as map(*), $tmpl as xs:string) {
    ...
    <ul class="unstyled">
    {
        ...
        return
            <li><a href="{$_tmpl}.html?type={$chamber}&amp;mainnav={$name}" title="{$menu/identifier}">{$name}</a></li>                
    }
    </ul>    
};
...
declare function app:sub-menus($node as node(), $model as map(*)) {
    ...
    <ul class="unstyled">
    {
        ...
        let $name := substring-after($trimmed,'/')
        return
            <li><a href="{$app:MAINNAV}.html?type={$chamber}&amp;mainnav={$app:MAINNAV}&amp;submenu={$name}" title="{$menu/identifier}">{$name}</a></li>                
    }
    </ul>    
};
