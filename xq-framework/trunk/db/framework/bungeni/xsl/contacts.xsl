...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:an="http://www.akomantoso.org/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:i18n="http://exist-db.org/xquery/i18n" xmlns:bu="http://portal.bungeni.org/1.0/" exclude-result-prefixes="xs" version="2.0">
    ...
    <xsl:template match="doc">
        ...
        <xsl:variable name="member-name" select="concat(bu:ontology/bu:membership/bu:firstName,' ', bu:ontology/bu:membership/bu:lastName, ' (',bu:ontology/bu:membership/bu:title,')')"/>
        <xsl:variable name="member-name-title" select="concat(bu:ontology/bu:membership/bu:salutation,', ',bu:ontology/bu:membership/bu:firstName,' ', bu:ontology/bu:membership/bu:lastName)"/>
        <div id="main-wrapper">
            <div id="title-holder">
                <h1 class="title">
                    <xsl:choose>
            ...
            <div id="region-content" class="rounded-eigh tab_container" role="main">
                <div id="doc-main-section">
                    <xsl:for-each select="ref/bu:ontology">
                        ...
                        <a id="mTag{bu:address/bu:addressId}" href="#" class="togglers" onClick="toggleOnly('{bu:address/bu:postalAddressType}{bu:address/bu:addressId}',this.id,'{bu:address/bu:logicalAddressType}');">
