            ...
            <div id="title-holder">
                <h1 class="title">
                    <xsl:if test="bu:ontology">
                        <xsl:value-of select="bu:ontology/bu:legislature/bu:parentGroup/bu:fullName"/>                    
                        &#160;|&#160;
                    </xsl:if>
                    ...
                    <div id="doc-main-section">
                        <div id="doc-main-section">
                            ...
                            <div class="list-block">
                                ...
                                <xsl:value-of select="bu:ontology/bu:legislature/bu:parentGroup/bu:status"/>
                            </div>
                            <div class="list-block">
                                <div class="block-label">
                                    <i18n:text key="parl-shortname">short name(nt)</i18n:text>:
                                </div>
                                <xsl:value-of select="bu:ontology/bu:legislature/bu:parentGroup/bu:shortName"/>
                            </div>
                            <div class="list-block">
                                <div class="block-label">
                            ...
                            <div class="list-block">
                                ...
                                <xsl:value-of select="format-date(bu:ontology/bu:legislature/bu:parentGroup/bu:startDate,'[D1o] [MNn,*-3], [Y]', 'en', (),())"/>
                            </div>
                        </div>
                        <div class="clear"/>
                        <div class="mem-desc">
                            <xsl:copy-of select="bu:ontology/bu:legislature/bu:parentGroup/bu:description"/>
                        </div>
                    </div>
                </div>
            </xsl:if>
