                    ...
                    <div class="mem-profile">
                        ...
                        <div class="mem-top-right">
                            <div id="doc-main-section" class="mem-details">
                                <xsl:if test="bu:ontology/bu:membership/bu:memberElectionType">
                                ...
                                <xsl:if test="bu:ontology/bu:membership/bu:electionDate">
                                    <div class="list-inline">
                                        <div class="inline-label">
                                            <i18n:text key="Election/Nomination Date">Election/Nomination Date</i18n:text>:
                                        </div>
                                        <xsl:value-of select="format-date(xs:date(bu:ontology/bu:membership/bu:electionDate),$date-format,'en',(),())"/>
                                    </div>
                                </xsl:if>
                                <div class="list-inline">
                                    <div class="inline-label">
