            ...
            <div id="region-content" class="rounded-eigh tab_container" role="main">             
                ...
                <div id="doc-listing" class="acts">
                    ...
                    <div class="whatson-wrapper">
                        ...
                        <div class="right">
                            <p id="range-cal"/>
                            <form class="whatson-form" id="whatson-filter-form" name="whatson_filter_form" method="GET" action="{$chamber}/whatson">
                        ...
                        <ul class="scheduling">
                            <li>
                                ...
                                <xsl:if test="bu:venue ne ''">
                                    &#160;<b>
                                        <i18n:text key="Venue">venue(nt)</i18n:text>
                                    </b>&#160;<xsl:value-of select="bu:venue"/>
                                </xsl:if>
                            </li>
                            <xsl:for-each select="bu:scheduleItem">
                                ...
                                <xsl:choose>
                                    <xsl:when test="bu:realItemType eq 'heading'">
                                        <li>
                                            <h4>
                                    ...
                                    <xsl:when test="bu:realItemType eq 'editorial_note'">
                                        <li>
                                            <p class="timeline-action">
                                                <xsl:copy-of select="bu:title/child::node()"/>
                                            </p>
                                        </li>
                                    </xsl:when>
                                    <xsl:otherwise>
